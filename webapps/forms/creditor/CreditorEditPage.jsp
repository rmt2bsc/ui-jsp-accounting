			...
			<form name="DataForm" method="post" action="<%=APP_ROOT%>/unsecureRequestProcessor/Creditor.Edit">
			   ...
			   <table>
				<tr>
				   ...
				   <td><input type="button" name="<%=GeneralConst.REQ_DELETE %>" value="Delete" style="width:90" tabIndex="31" onClick="handleAction('_self', DataForm, this.name)"></td>
				   <td><input type="button" name="<%=GeneralConst.REQ_BACK %>" value="Back" style="width:90" tabIndex="32" onClick="handleAction('_self', DataForm, this.name)"></td>
				</tr>
			</table>
