 ...
 * Accounting Inventory Item Master Types.
 * 
 * 
 * @author Roy Terrell
 *
 */
public class ItemTypeSoapRequests extends SubsidiarySoapRequests {
    private static final Logger logger = Logger.getLogger(ItemTypeSoapRequests.class);
    private static final String MSG = "SOAP invocation error occurred regarding server-side messaging";

    /**
     * SOAP call to fetch all inventory item types.
     * 
     * @param loginId
    ...
    public static final InventoryResponse callGet(String loginId, String sessionId) throws AccountingUIException {
        ...
        try {
            ...
            throw new AccountingUIException(ItemTypeSoapRequests.MSG, e);
        }
    }
