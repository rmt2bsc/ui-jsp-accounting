...
public class CustomerConst {
    /** 
     * Property names for search criteria deriving from the customer entity.
     */
    public static String CRITERIATAGS_CUSTOMER[] = { "Arg_AccountNo", "Arg_CustomerId", "Arg_CustomerIdList" };
